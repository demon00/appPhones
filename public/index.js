...
var _phoneViewer = __webpack_require__(9);

var _phoneViewer2 = _interopRequireDefault(_phoneViewer);
...
var _httpService = __webpack_require__(6);

var _httpService2 = _interopRequireDefault(_httpService);

var _phoneGallary = __webpack_require__(8);

var _phoneGallary2 = _interopRequireDefault(_phoneGallary);
...
var PhonePage = function () {
  function PhonePage(options) {
    _classCallCheck(this, PhonePage);
  ...
  _createClass(PhonePage, [{
    key: 'initGallary',
    value: function initGallary() {
      this._phoneGallary = new _phoneGallary2.default({
    ...
    value: function initViewer() {
      ...
      this._viewer = new _phoneViewer2.default({
        el: this._el.querySelector('[data-component="phoneViewer"]')
      });

      this._viewer.on('phoneSelected', function (event) {
        _this._shoppingCart.addItem(event.detail);
      });
    }
  }, {
    key: 'initShoppingCart',
    value: function initShoppingCart() {
      this._shoppingCart = new _shoppingCart2.default({
    ...
    value: function initSearch() {
      ...
      this._search = new _search2.default({
        el: this._el.querySelector('[data-component="search"]')
      });

      this._search.on('valueChanged', function (event) {
        var query = event.detail;

        _this2._loadPhones(query);
      });
    }
  }, {
    key: 'initCatalogue',
    value: function initCatalogue() {
      var _this3 = this;
      ...
      this._catalogue.on('phoneSelected', function (event) {
        var phoneId = event.detail;
        _this3._loadPhoneDetails(phoneId);
      });

      this._loadPhones();
    }
  }, {
    key: '_loadPhoneDetails',
    value: function _loadPhoneDetails(phoneId) {
      var url = '/data/phones/' + phoneId + '.json';

      _httpService2.default.request(url, {
        method: 'GET',
    ...
    key: '_onPhoneDetailsLoaded',
    value: function _onPhoneDetailsLoaded(phoneData) {
    ...
    key: '_onPhonesLoaded',
    value: function _onPhonesLoaded(phones) {
...
/* harmony export (immutable) */ __webpack_exports__["default"] = HttpService;
...
var PhoneCatalogue = function (_Component) {
  ...
  function PhoneCatalogue(options) {
    ...
    var _this = _possibleConstructorReturn(this, (PhoneCatalogue.__proto__ || Object.getPrototypeOf(PhoneCatalogue)).call(this, options.el));
  ...
  _createClass(PhoneCatalogue, [{
    ...
    value: function _onPhoneClick(event) {
      var phoneItemLink = event.target.closest('[data-element="phoneItemLink"]');

      if (!phoneItemLink) {
        return;
      }

      var selectedPhoneItem = phoneItemLink.closest('[data-element="phoneItem"]');
...
var PhoneGallary = function (_Component) {
  _inherits(PhoneGallary, _Component);

  function PhoneGallary(options) {
    _classCallCheck(this, PhoneGallary);

    var _this = _possibleConstructorReturn(this, (PhoneGallary.__proto__ || Object.getPrototypeOf(PhoneGallary)).call(this, options.el));

    _this._el.addEventListener('click', _this._onImageClick.bind(_this));
    return _this;
  }

  _createClass(PhoneGallary, [{
    key: 'setData',
    value: function setData(phone) {
    ...
    key: '_onImageClick',
    value: function _onImageClick(event) {
      this._clickImage = event.target.closest('[data-phone-src="phone-image"]');
      if (this._clickImage) {
        var phoneViewerComponent = document.querySelector('[data-component="phoneViewer"]');
        var mainImage = phoneViewerComponent.querySelector('[data-element="phone-main-image"]');
...
var PhoneViewer = function (_Component) {
  ...
  function PhoneViewer(options) {
    ...
    var _this = _possibleConstructorReturn(this, (PhoneViewer.__proto__ || Object.getPrototypeOf(PhoneViewer)).call(this, options.el));

    _this._el.addEventListener('click', _this._onButtonClick.bind(_this));
    return _this;
  }
  ...
  _createClass(PhoneViewer, [{
    ...
    key: '_hideItemComponent',
    value: function _hideItemComponent() {
      this._el.classList.add('js-hidden');
      document.querySelector('[data-component="phoneGallary"]').classList.add('js-hidden');
    }
  }, {
    key: '_showCatalog',
    value: function _showCatalog() {
      var catalogComponent = document.querySelector('[data-component="phoneCatalogue"]');
      catalogComponent.classList.remove('js-hidden');
    }
  }, {
    key: '_addToBasket',
    value: function _addToBasket() {
      var selectedPhoneItem = this._el.querySelector('[data-element="phoneViewerItem"]');
    ...
    value: function _onButtonClick(event) {
      var clickButtonBack = event.target.closest('[data-element="butBack"]');
      if (clickButtonBack) {
        window.history.back();
        this._showCatalog();
        this._hideItemComponent();
      }
      var clickButtonAdd = event.target.closest('[data-element="butAdd"]');
      if (clickButtonAdd) {
        this._addToBasket();
      }
    }
...
var Search = function (_Component) {
  ...
  function Search(options) {
    ...
    var _this = _possibleConstructorReturn(this, (Search.__proto__ || Object.getPrototypeOf(Search)).call(this, options.el));

    _this._field = _this._el.querySelector('[data-element="field"]');

    _this._field.addEventListener('input', _this._onFieldInput.bind(_this));
    return _this;
  }
...
var ShoppingCart = function (_Component) {
  ...
  function ShoppingCart(options) {
    ...
    var _this = _possibleConstructorReturn(this, (ShoppingCart.__proto__ || Object.getPrototypeOf(ShoppingCart)).call(this, options.el));
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n		<li class=\"thumbnail\" data-element=\"phoneItem\" data-phone-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n			<a href=\"#!/phones/"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"thumb\" data-element=\"phoneItemLink\">\n				<img alt=\""
    + ((stack1 = alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0)) != null ? stack1 : "")
    + "\" src=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.imageUrl : stack1), depth0))
    + "\">\n			</a>\n\n			<a href=\"#!/phones/"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" data-element=\"phoneItemLink\">"
    + ((stack1 = alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0)) != null ? stack1 : "")
    + "</a>\n\n			<p>"
    + ((stack1 = alias1(((stack1 = blockParams[0][0]) != null ? stack1.snippet : stack1), depth0)) != null ? stack1 : "")
    + "</p>\n		</li>\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "<ul class=\"phones\">\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.phones : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</ul>";
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "		<li>\n			<img src=\""
    ...
    + "\" data-phone-src=\"phone-image\">\n		</li>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1;

  return "<ul class=\"phone-thumbs\">\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.phone : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "</ul>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<button data-element=\"butBack\" class=\"button button__back\">Back</button>\n<button data-element=\"butAdd\" class=\"button button__add\">Add to basket</button>\n<div>\n	<img class=\"phone\" alt=\""
    + ((stack1 = alias1(((stack1 = (depth0 != null ? depth0.phone : depth0)) != null ? stack1.name : stack1), depth0)) != null ? stack1 : "")
    + "\" src=\""
    + ((stack1 = alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.phone : depth0)) != null ? stack1.images : stack1)) != null ? stack1["0"] : stack1), depth0)) != null ? stack1 : "")
    + "\" data-element=\"phone-main-image\">\n	<h1 data-element=\"phoneViewerItem\" data-phone-id=\""
    + ((stack1 = alias1(((stack1 = (depth0 != null ? depth0.phone : depth0)) != null ? stack1.id : stack1), depth0)) != null ? stack1 : "")
    + "\">"
    + ((stack1 = alias1(((stack1 = (depth0 != null ? depth0.phone : depth0)) != null ? stack1.id : stack1), depth0)) != null ? stack1 : "")
    + "</h1>\n	<p>"
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n	<ul class=\"selected-phones\">\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.orderItems : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "	</ul>\n\n";
  ...
  return "<h3>Shopping cart</h3>\n\n"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},((stack1 = (depth0 != null ? depth0.orderItems : depth0)) != null ? stack1.length : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
var _phonePage = __webpack_require__(5);

var _phonePage2 = _interopRequireDefault(_phonePage);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var page = new _phonePage2.default({ el: document.body });
