...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_http_service__ = __webpack_require__(6);
...
class PhonePage {
  ...
  _loadPhones(query = '') {
    ...
    __WEBPACK_IMPORTED_MODULE_5__services_http_service__["a" /* default */].request(url, {
      method: 'GET',
      success: (phones) => {
